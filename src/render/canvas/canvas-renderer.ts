...
import type { TextShadow } from '../../css/property-descriptors/text-shadow';
...
import { CSSImageType, type CSSURLImage, isLinearGradient, isRadialGradient } from '../../css/types/image';
import { FIFTY_PERCENT, getAbsoluteValue } from '../../css/types/length-percentage';
import { type ElementContainer, FLAGS } from '../../dom/element-container';
import { SelectElementContainer } from '../../dom/elements/select-element-container';
import { TextareaElementContainer } from '../../dom/elements/textarea-element-container';
import type { ReplacedElementContainer } from '../../dom/replaced-elements';
...
import { type BezierCurve, isBezierCurve } from '../bezier-curve';
import {
  parsePathForBorder,
...
import { EffectTarget, type IElementEffect, isClipEffect, isOpacityEffect, isTransformEffect } from '../effects';
import { FontMetrics } from '../font-metrics';
import { type Path, transformPath } from '../path';
import { Renderer } from '../renderer';
import { type ElementPaint, parseStackingContexts, type StackingContext } from '../stacking-context';
