...
import { type CSSPropertyDescriptor, PropertyDescriptorParsingType } from './IPropertyDescriptor';
...
import { type OVERFLOW, overflow } from './property-descriptors/overflow';
...
import { type CSSValue, isIdentToken, Parser } from './syntax/parser';
import { Tokenizer } from './syntax/tokenizer';
import { angle } from './types/angle';
import { type Color, color as colorType } from './types/color';
import { isTransparent } from './types/color-utilities';
import { image } from './types/image';
import { isLength } from './types/length';
import { isLengthPercentage, type LengthPercentage, ZERO_LENGTH } from './types/length-percentage';
