...
describe('types', () => {
  describe('<color>', () => {
    describe('parsing', () => {
      ...
      it('color(xyz 0.11 0.17 0.24)', () => strictEqual(parse('color(xyz 0.11 0.17 0.24)'), pack(0, 130, 131, 1)));
      ...
      it('color(prophoto-rgb 1 0.5 0)', () => strictEqual(parse('color(prophoto-rgb 1 0.5 0)'), pack(255, 99, 0, 1)));
      it('color(rec2020 0.17 0.31 0.5)', () => strictEqual(parse('color(rec2020 0.17 0.31 0.5)'), pack(0, 97, 144, 1)));
      ...
      it('color(from green srgb r g b)', () => strictEqual(parse('color(from green srgb r g b)'), pack(0, 128, 0, 1)));
      it('color(from lime srgb r g b)', () => strictEqual(parse('color(from lime srgb r g b)'), pack(0, 255, 0, 1)));
      ...
      it('color(from lab(52.14 -26.38 -20.37) display-p3 r g calc(r / 2))', () =>
        strictEqual(parse('color(from lab(52.14 -26.38 -20.37) display-p3 r g calc(r / 2))'), pack(5, 138, 0, 1)));
